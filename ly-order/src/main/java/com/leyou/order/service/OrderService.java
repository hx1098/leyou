...
public class OrderService {
    ...
    public Long createOrder(OrderDTO orderDTO) {
        ...
        List<Sku> skus = goodsClient.querySkuByIds(new ArrayList<Long>(ids));
        ...
        if(count != 1){
            ...
            throw new LyExcetion(ExceptionEnum.CREATE_ORDER_ERROR);
        }
    ...
    public Order queryOrderById(Long id) {
        ...
        if(CollectionUtils.isEmpty(orderDetails)){
            throw new LyExcetion(ExceptionEnum.ORDER_DETAIL_NOT_FOUNT);
        }
    ...
    public String createPayUrl(Long orderId) {
        ...
        if(status != OrderStatusEnum.UN_PAY.value()){
            throw new LyExcetion(ExceptionEnum.ORDER_STATUS_ERROE);
        }
    ...
    public void handleNotify(Map<String, String> result) {
        ...
        if(StringUtils.isEmpty(totalFeeStr) || StringUtils.isEmpty(tradeNo)){
            throw new LyExcetion(ExceptionEnum.INVALID_ORDER_PARAM);
        }
